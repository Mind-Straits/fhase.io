...
// import firebaseQueries from "@/app/firebase/firebaseQueries"; // Assuming you've imported your Firebase queries
...
//       try {
//         const userData = await firebaseQueries.getDocumentById("users", "userId"); // Replace "userId" with the actual user ID
